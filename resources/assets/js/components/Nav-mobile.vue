...
Descripción:
 ...
 <template>
  <div>
    ...
    <!-- barra movil -->
    <nav class="nav justify-content-center p-0 text-uppercase w-75 fixed-top h-100 collapse  d-xl-none d-lg-none navbar-expand fade" id="menu-mov" style="background-color: #2c3e50 ">
      <!-- menu2 movil-->
      <ul class="d-flex flex-column justify-content-center w-90 h-100 m-0 align-items-stretch p-0 flex-nowrap container">
       ...
       <!--  <li class="p-2 d-flex align-items-center"><router-link to="/noticias" class="btn p-1 font-weight-bold text-white">Noticias</router-link></li> -->
        ...
        <li class="p-2 d-flex align-items-center"><router-link to="/preguntas-frecuentes-encuestas" class="btn p-1 font-weight-bold text-white">Preguntas Frecuentes y Encuestas</router-link></li>
        ...
        <li class="p-2 d-flex align-items-center"><a href="#" onclick="return false" class="btn p-1 font-weight-bold text-white">Proyectos asociados</a>
          <!-- Submenu -->
          <ul class="verde position-absolute submenu-movil" style="left: 20%;" >
             <router-link to="/asociados/nagoya-lumpur"><li class="p-3 text-white font-weight-bold btn-verde">Nagoya-Lumpur</li></router-link>
          </ul>
        </li>
        <li class="p-2 d-flex align-items-center"><router-link to="/laboratorio-nacional-ovm" class="btn p-1 font-weight-bold text-white">Lab. Nacional de detección de OVM</router-link></li>
        <li class="p-2 d-flex align-items-center"><a href="#" onclick="return false" class="btn p-1 font-weight-bold text-white">Recursos</a>
        <!-- Submenu -->
