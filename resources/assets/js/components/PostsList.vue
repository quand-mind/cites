<template>
    <div>
        <b-button href="posts/create" variant="primary"
            >Crear un nuevo post</b-button
        >
        <v-client-table :data="tableData" :columns="columns" :options="options">
            ...
            <b-img
                ...
                :src="
                    props.row.main_image &&
                        '/storage/images/posts/' + props.row.main_image.url
                "
            ...
            <span slot="titulo" slot-scope="props">
                <a :href="`posts/edit/${props.row.id}`">{{
                    props.row.title
                }}</a>
            </span>
...
export default {
    ...
    methods: {
        ...
        handleCheckBoxChange(row) {
            ...
            _this.tableData[postIdx].is_active = !_this.tableData[postIdx]
                .is_active;
