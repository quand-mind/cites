    ...
    <b-card class="">
      <b-card-text>
        ...
        <b-row class="mt-4 mb-2">
          <b-col cols="4">Tipo de Permiso:</b-col>
        </b-row>
        <b-row>
          <b-col cols="4">
            <b-form-select v-model="permit.type"
...
export default {
  ...
  methods: {
    ...
    deleteRequeriment(requeriment){
      const index = this.permit.requeriments.findIndex(requerimentA => requerimentA.value === requeriment )
    ...
    checkRequeriments(){
      for (const requeriment of this.permit.requeriments) {
        const index = this.requeriments.findIndex(requerimentA => requerimentA.value === requeriment )
        // console.log(index)
        if (index){
