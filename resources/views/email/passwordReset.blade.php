...
<body>
    <div class="container justify-conten">
        <div class="row mx-lg-n5 d-flex justify-content-center py-3 bg-light">
            ...
            <div class="col-6">
                <h1>Tiene 10 Minutos para restaurar su contraseña a través del siguiente enlace: </h1>
                <a class="btn btn primary   " href={{ $url . '/recoveryPassword?token=' . $token }}>Click en el enlace.</a>
                <p>Att: MINEC</p>
                <br/>
            </div>
        </div>
