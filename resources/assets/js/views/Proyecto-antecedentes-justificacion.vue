...
<!-- Escrito -->
	<div class="d-flex flex-column p-5 text-justify">
		...
		<div class="mr-3">
			<img src="/images/caja1.jpg" class="m-1 p-1 border border-succes rounded-sm" width="250">
		</div>
		...
		<div class="d-flex flex-column flex-lg-row flex-xl-row align-items-center">
			...
			consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
			cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
			proLorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
			tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
			quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
			consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
			cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
			pro</p>
			<div class="ml-3">
					<img src="/images/caja2.jpg" class="m-1 p-1 border border-succes rounded-sm" width="250">
				</div>
		</div>
