...
Descripción:
	pie de pagina, contiene links a las redes sociales y boton para subir al principio de la pagina
 -->

 <template>
  <div>
	<footer class="azul modal-footer d-flex flex-column align-items-center" >
